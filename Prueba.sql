...
-- Volcando datos para la tabla bdinventario.infomovimientos: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla bdinventario.movimientos_productos: ~3 rows (aproximadamente)
INSERT INTO `movimientos_productos` (`id`, `cantidadUsada`, `idProducto`, `idUsuario`, `fecha`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(21, 8.00, 14, 13, '2024-12-03', '2024-12-04 04:05:05', '2024-12-04 04:05:05', NULL),
	(22, 1.00, 14, 13, '2024-12-04', '2024-12-05 02:55:47', '2024-12-05 02:55:47', NULL);
...
-- Volcando datos para la tabla bdinventario.productos: ~2 rows (aproximadamente)
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `imagen`, `cantidad`, `idCategoria`, `unidad_medida_id`, `cantidad_minima`, `fecharegistro`, `cantidad_unidad_compuesta`, `cantidad_total`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(13, 'Lapiz', 'Producto', 'uploads/1733242197_logo.png', 0.00, 3, 6, 1.00, '2024-12-03', NULL, NULL, '2024-12-03 20:42:48', '2024-12-04 03:44:49', '2024-12-04 03:44:49'),
	(14, 'Lapiz', 'sasa', 'uploads/1733265739_Log.png', 1.00, 4, 10, 0.00, '2024-12-03', 1.0000, 1.0000, '2024-12-04 03:42:19', '2024-12-05 02:55:47', NULL);
...
-- Volcando datos para la tabla bdinventario.unidades_medida: ~4 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `nombres`, `apellidos`, `imagen`, `email`, `password`, `rol`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(12, 'Eilen', 'Rodriguez', '/assets/Recursos/prede.jpg\r\n', 'Eilen.Rodriguez@impresistem.com', '$2y$10$PJKt1r5aA5AzxmCKCXPZfu5m4mb1FN2LDyYXAAeKhkTeW3YQLDIeC', 'Administrador', '2024-12-03 20:36:02', '2024-12-03 20:36:02', NULL),
